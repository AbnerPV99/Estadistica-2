...
#Algoritmo que calcula la b, a y forma la ecuacion de la recta. Retorna el valor de la estimacion
def algoritmo_minimos_cuadrados(n, x, y, z):
    ...
    for i in range(n):
        ...
        print(str(x[i]) + "\t" + str(y[i]) + "\t" + str(x[i]*y[i]) + "\t" + str(x[i]**2)) # Muestra cada fila de x, y, x*y, x^2 
    print("-"*100)
    print(str(sumaX) + "\t" + str(sumaY) + "\t" + str(sumaXY) + "\t" + str(sumaX2)) # Muestra la sumatoria de x, y, x*y, x^2
    ...
    print("\nLa ecuación de la recta es Y = {}x + {}".format(b, a)) # Muestra la ecuacion
